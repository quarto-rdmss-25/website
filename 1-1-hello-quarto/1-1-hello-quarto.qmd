...
- Navigate to the GitHub organisation for the course [ost-hs23](https://github.com/ost-hs23)
- Under Repositories, and use search dialogue {{< fa magnifying-glass >}} to search for your GitHub username
- Click on the repository with your username (exercises-USERNAME)
- Click on the green Code button and copy the URL
- Open RStudio in Posit Cloud 
- Under Content, Click New Project > New Project from Git Repository
