...
# Quarto {.center-align background-color="#461a52"}
...
Every student will have a personal, published, free [website]{.highlight-yellow} that links to their (academic) [profiles]{.highlight-yellow}, shows [slides]{.highlight-yellow}, and has the potential to be used as a (scientific) [blog]{.highlight-yellow}.
:::
...
-   During [my turn]{.highlight-yellow} and [our turn]{.highlight-yellow} segments: Please keep your microphone on mute. Send message to the [Zoom chat]{.highlight-yellow} and we will try to support you. 
...
::: columns
::: {.column width="50%"}
One screen ![](images/bram-naus-N1gUD_dCvJE-unsplash.jpg)
:::

::: {.column width="50%"}
Two screens or more ![](images/daniel-korpai-vHVfpi3h5xk-unsplash.jpg)
:::
:::
...
- Open the workspace for the course: <https://posit.cloud/spaces/497061/content/all?sort=name_asc>
- Click "Start" next to Exercises
- Wait until the projeczt has deployed
...
Slides created via revealjs and Quarto: https://quarto.org/docs/presentations/revealjs/ Access slides as [PDF on GitHub](https://github.com/quarto-ambition/website/raw/main/1-1-hello-quarto/1-1-hello-quarto.pdf)
