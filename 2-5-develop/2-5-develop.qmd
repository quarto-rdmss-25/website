...
- Add a folder called `posts` and create minimal blog post entry - Collect postsfrom a blog page using the [listings feature](https://quarto.org/docs/websites/website-listings.html).
