...
4.  Be prepared to [explain how the recommended practices would improve your research process]{.highlight-yellow}. This will be [in the class setting]{.highlight-yellow} as part of small discussion group (max 3 people).
