...
Who of you has a LinkedIn account? 
:::

## {{< fa hand >}} {.center-align auto-animate="true"}

::: {style="margin-top: 50px; font-size: 1.5em"}
Who of has an ORCID iD? 
:::

## {{< fa hand >}} {.center-align auto-animate="true"}

::: {style="margin-top: 50px; font-size: 1.5em"}
Who of has a GitHub account? 
:::
...
::: {style="margin-top: 50px; font-size: 1.5em"}
Who of you has published a report, scientific article, or similar? 
...
-   Which tasks were challenging and frustrating?
