...
preparation before the first module and between the two modules. A pass is achieved if students actively participate in both modules and complete the exercises between the two modules. 
